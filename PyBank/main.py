...
# Change the directory to the directory of current python script
os.chdir(os.path.dirname(__file__))

# Path to Resources folder with csv data file
...
with open(budget_data_csv_path, newline="") as csvfile:
    ...
    for row in csv_reader:
        ...
        if (count_months == 1):
            # Set the value of previous month to be equal to current month
            ...
            # Set the current_month_loss to be previous_month_profit_loss for the next loop
            previous_month_profit_loss = current_month_profit_loss
